      ...
      <div class="row">
        ...
        <div class="col-10" id="profileC10">
          <div class="row" style="padding: 10px 10px 0px 10px;" v-if="likeProduck.length>0">
            ...
            <div class="col-12">
              <div>
                <b style="font-size:15px;font-family: sans-serif; ">Список желаний</b>
              </div>
            </div>
            ...
            <div class="col-12" style="margin-top: 5px;border-bottom:solid 1px #f4f4f4;" v-for="item in likeProduck" :key="item.id">
              <div class="row"  style="padding-right: 0px;padding-left: 0px; ">
                  <div class="col-12" style="padding-left: 0px;padding-right: 0px;padding:0px 15px;" >
                    <div class="col-1" style="text-align: center;padding-right: 0px;padding-left: 0px;">
                         <img id="cartimg" :src="'http://127.0.0.1:8000'+item.likeNEW.img1" alt="item1" style="width: 80px;height: auto;" />
                    </div>
                    <div class="col-9" id="col9" >
                        <div class="row" style="padding-right: 0px;padding-left: 0px;">
                          <div class="col-12" style="padding-right: 0px;padding-left: 0px;">
                              <span class="item-name">
                                <a  class="shripht" style="font-size: 12px; -webkit-box-orient: vertical;-webkit-line-clamp: 1;display: -webkit-box;overflow: hidden;" href="#"  @click="goTo(item.likeNEW.id)" >
                                  {{item.likeNEW.title}}
                                </a>
                              </span>
                              ...
                              <div>
                                <a class="shripht" href="/shop/like" @click="deleteLike(item)" >
                                  <span  
                                    class="item-price" 
          ...
          <div class="row" v-else >
            <div class="col-12" style="padding: 100px 0px;text-align: center;margin: 0 auto;">
              <h4>У вас нет товаров в избранном</h4>
            </div>
          </div>
        </div>
      ...
      <div class="col-12" style="padding-left: 0px;padding-right: 0px;width: 100%;background-color: white;border-bottom:solid 2px #f4f4f4;" v-for="item in likeProduck" :key="item.id" >
        <div class="row" style="padding-right: 0px;padding-left: 0px; width: 100%;margin-right: 0px;margin-left: 0px;">
          ...
          <div class="col-4" style="padding-right: 0px;padding-left: 0px; width: 100%;margin-right: 0px;margin-left: 0px;">
            <img style="width: 100%;margin-top: 4px;" :src="'http://127.0.0.1:8000'+item.likeNEW.img1" alt="item1" />
          </div>
          ...
          <div class="col-8" style="padding-left: 0px;padding-right: 0px;width: 100%;">
            <div class="row" style="padding-right: 0px;padding-left: 0px; width: 100%;margin-right: 0px;margin-left: 0px;">
              ...
              <div class="col-12" style="padding-left: 0px;padding-right: 0px;width: 100%;">
                <div class="title">
                  <h2 style="font-size: 14px;margin-top: 2px;-webkit-box-orient: vertical;-webkit-line-clamp: 2;display: -webkit-box;overflow: hidden;">{{item.likeNEW.title}}</h2>
                </div>
              </div>
              ...
              <div class="col-10" style="text-align: end;padding-left: 0px;padding-right: 0px;width: 100%;margin-top: 10px;">
                <a class="shripht" href="/shop/like" @click="deleteLike(item)" >
                  <span  
                    class="item-price" 
