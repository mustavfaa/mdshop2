<template>
  ...
  <transition 
    ...
    <ul v-show="list.open" class="list-item">
      <li class="sub-items">
        <a id="clickA" href="/category/aplle">Смартфоны Apple</a>
      </li>
      <li class="sub-items">
        <a id="clickA" href="/category/samsung">Смартфоны Samsung</a>
      </li>
      <li class="sub-items">
        <a id="clickA" href="/category/huawei">Смартфоны Huawei</a>
      </li>
      <li class="sub-items">
        <a id="clickA" href="/category/xiaomi">Смартфоны Xiaomi</a>
      </li>
      <li class="sub-items">
        <a id="clickA" href="/category/oppo">Смартфоны OPPO</a>
      </li>
      <li class="sub-items">
        <a id="clickA" href="/category/xiaomi">Недорогие смартфоны</a>
      </li>
    </ul>
  </transition>
</template>
